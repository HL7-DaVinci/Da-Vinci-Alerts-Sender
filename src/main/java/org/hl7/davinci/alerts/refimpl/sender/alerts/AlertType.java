package org.hl7.davinci.alerts.refimpl.sender.alerts;

public class AlertType {
    public static final String ADMIT_ER = "alert-admit-er";
    public static final String ADMIT_INPATIENT = "alert-admit-inpatient";
